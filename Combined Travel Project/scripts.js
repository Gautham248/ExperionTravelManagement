document.addEventListener('DOMContentLoaded', () => {
    ...
    // Track which table is being filtered
    ...
    async function fetchTravelRequests() {
        try {
            ...
            // Fetch travel requests data next
    ...
    function processRequests(travelRequestsData, employeesData) {
        ...
        if (travelRequestsData) {
            ...
            Object.entries(travelRequestsData).forEach(([requestId, request]) => {
                ...
                if (employeesData[request.employeeId] && employeesData[request.employeeId].name) {
                    employeeName = employeesData[request.employeeId].name;
                }
    ...
    document.getElementById("clearFilter").addEventListener("click", () => {
        resetFilterForm();
        closeModal();
        renderTravelRequests(); // Reset tables to original state
    });
});
